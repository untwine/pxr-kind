...
class PxrKindConan(ConanFile):
    name = "pxr-kind"
    version = "26.8"
    package_type = "library"
    license = "LicenseRef-TOST-1.0"
    homepage = "https://github.com/untwine/pxr-kind"
    url = "https://github.com/untwine/pxr-kind"
    ...
    def configure(self):
        ...
        if self.options.python_version:
            ...
            self.options["pxr-plug"].python_version = self.options.python_version

    def requirements(self):
        self.requires("pxr-tf/26.8")
        self.requires("pxr-plug/26.8")
        if self.options.python_version:
    ...
    def package_info(self):
        ...
        self.cpp_info.builddirs = ["share/cmake/pxr-kind"]
        self.cpp_info.libs = ["PxrKind"]
